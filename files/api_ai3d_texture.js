...
module.exports = withErrors(async (req, res) => {
  ...
  sendJson(res, 200, {
    ...
    maxTextureUploadMb: Math.max(1, Math.min(Number(process.env.AI3D_MAX_TEXTURE_UPLOAD_MB) || 250, 2048)),
    modes: ['auto', 'image_to_3d', 'depth', 'building', 'map', 'voxel_city', 'texture_optimize'],
    deliveryPolicy: deliveryPolicyForClient(),
    deliveryStatus: deliveryStatusForClient()
  });
});
