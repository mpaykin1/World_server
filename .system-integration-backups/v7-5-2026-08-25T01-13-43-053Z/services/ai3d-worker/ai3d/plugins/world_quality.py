...
class WorldQualityEnhancer:
 VERSION='5.0.0'; STRATEGY='semantic_multiscale_architecture_material_aware'
 @staticmethod
 def _hash(x,y,s):
 ...
 def enhance_voxel_world(self,world_path:Path,params:dict|None=None)->Path:
  ...
  if self._front(source)!=self._front(enhanced):raise RuntimeError('WORLD_QUALITY_AUTOPILOT_V5 front-projection invariant violated')
