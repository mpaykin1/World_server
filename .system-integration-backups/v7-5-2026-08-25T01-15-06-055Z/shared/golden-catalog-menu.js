...
(function () {
  function makeMenu(apps) {
    ...
    style.textContent = `
      ...
      @media(pointer:coarse),(max-width:800px){#goldenWorldMenu{top:max(8px,env(safe-area-inset-top));left:8px;right:8px;transform:none;max-width:none}#goldenWorldMenu a{min-width:112px;min-height:46px}}
    `;
