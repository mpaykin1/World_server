...
async function handle(admin, req, body) {
  ...
  if (!Array.isArray(world.houses) || !Array.isArray(world.history)) throw httpError(409, 'Invalid saved world shape');
  world.history = world.history.filter(e=>e&&typeof e==='object'&&!Array.isArray(e));
