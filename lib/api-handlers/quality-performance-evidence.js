...
module.exports = async function handler(req,res){
  ...
  if(!process.env.DATABASE_URL||!neon){console.log('QUALITY_PERFORMANCE_EVIDENCE',JSON.stringify(row));return res.status(202).json({ok:true,durable:false,qualitySafe:true,safeSchedule:row.schedule});}
