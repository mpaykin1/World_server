...
function hasDirectMicrodetailIntegration(source=''){
  return /(?:universal[-_]voxel[-_]microdetail|microdetail(?:Runtime|Geometry|Material|Bootstrap)?)/i.test(String(source));
}
...
module.exports={
  ...
  selectRepresentation,validatePolicy,hasDirectMicrodetailIntegration
};
