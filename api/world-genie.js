...
const {safeWorldId}=require('../lib/voxel-rules');
...
module.exports=withErrors(async(req,res)=>{
 ...
 const identity=await requireUser(admin,req);
 const result=await dispatch(admin,identity.user.id,body);
 sendJson(res,200,result);
});
module.exports._private={dispatch,readWorld,persist,validateIntent,expectedRevision};
