...
let report={schemaVersion:'4.0.0',system:'WORLD_SEMANTIC_DETAIL_INDEX',generatedAt:new Date().toISOString(),source,available:false,stats:null};
...
console.log(`[WORLD_SEMANTIC_DETAIL_V4] ${report.available?'indexed':'no world artifact'}${report.stats?` · ${report.stats.cells} facade cells`:''}`);
