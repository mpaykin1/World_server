...
function checksForDomain(){
 ...
 return{
  ...
  graphics:[
   ...
   {id:'authored-pbr-material-forge',weight:10,ok:exists('lib/material-forge.js')&&exists('shared/graphics/material-forge-runtime.js')&&has('package.json','material-forge:check')},
   {id:'armorpaint-provenance-budget-guards',weight:8,ok:has('data/material-forge/policy.json','runtime16kForbidden')&&has('lib/material-forge.js','source.projectFile')},
  ...
  optimization:[
   ...
   {id:'adaptive-authored-material-budget',weight:8,ok:has('shared/graphics/material-forge-runtime.js','setTextureBudgetScale')&&has('data/material-forge/policy.json','maxRuntimeDimension')},
  ...
  automation:[
   ...
   {id:'material-forge-drift-check',weight:7,ok:exists('scripts/material-forge.js')&&has('package.json','material-forge:check')},
