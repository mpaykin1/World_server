...
const resized = compareReferenceRuntime(reference, { width: 1, height: 1, pixels: Uint8Array.from([100,100,100,255]) });
assert.strictEqual(resized.resampled, true);
assert.strictEqual(resized.comparisonWidth, 1);
assert.strictEqual(resized.comparisonHeight, 1);
