...
(function () {
  function makeMenu(apps) {
    ...
    style.textContent = `
      #goldenWorldMenu{position:fixed;left:50%;top:14px;transform:translateX(-50%);z-index:2147483400;display:flex;gap:8px;max-width:min(94vw,900px);padding:8px;border-radius:14px;background:rgba(5,9,14,.78);border:1px solid rgba(255,255,255,.16);backdrop-filter:blur(10px);overflow-x:auto;overscroll-behavior:contain}
