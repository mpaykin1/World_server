...
const persistCpuProfile=row=>insert('quality_cpu_runtime_profiles_v11',row);const persistCpuCacheEvent=row=>insert('quality_cpu_cache_events_v11',row);
module.exports={persistCpuProfile,persistCpuCacheEvent,creds};
