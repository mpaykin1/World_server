...
def main():
    ap=argparse.ArgumentParser(description='Safely install V8 shared quality core into World_server with backup, world preservation and full verification.')
