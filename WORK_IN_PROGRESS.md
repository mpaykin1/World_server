...
## 2026-09-26 — Original volcanic GLB models; upstream license audit
Owner: ChatGPT Graphics. Scope: original CPU Blender procedural basalt, geothermal module and pipe/rail modules, separate graphics-owned branch. Source research: Prokopiy8247/Claude-Opus-5.5-Minecraft root and three engine subfolders LICENSE all 404; README says original but no reuse grant verified. Do NOT copy upstream meshes, blend files, textures or code. Target: original reproducible GLB generation with clean-room procedural geometry and legal audit; no backend or master modifications. Risks: unlicensed upstream assets, Blender version differences, import scale. Plan: new generator + audit doc + dry validation, draft PR; review and CI before integration into #301. Current: branch created, generator pending. Next: generate script and verify Blender where available. Completion: exact SHA, asset reproducibility, visual captures and review; live FPS NOT_VERIFIED.
