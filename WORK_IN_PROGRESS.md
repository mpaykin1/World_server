...
- Target: fresh `origin/master`-derived branch `ai/science/run072-production-integration`, then one clean integration commit and push.
...
- Next action: final diff review, amend the clean integration commit with the three transitive harness scripts, then push.
