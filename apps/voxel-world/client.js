...
function pushFace(arr,x,y,z,face,vertexShade=null,shore=0,materialId=0){const packedShore=arr.shore?Math.round(shore*65535):0,isSolid=arr.mat!==undefined,v0=face.v[0],v1=face.v[1],v2=face.v[2],v3=face.v[3],nx=face.d[0],ny=face.d[1],nz=face.d[2];arr.pos.push(x+v0[0],y+v0[1],z+v0[2],x+v1[0],y+v1[1],z+v1[2],x+v2[0],y+v2[1],z+v2[2],x+v3[0],y+v3[1],z+v3[2]);arr.nor.push(nx,ny,nz,nx,ny,nz,nx,ny,nz,nx,ny,nz);if(arr.col){const faceColors=FACE_COLOR_BY_MATERIAL[materialId][face.colorIndex],c0=faceColors[vertexShade[0]],c1=faceColors[vertexShade[1]],c2=faceColors[vertexShade[2]],c3=faceColors[vertexShade[3]];arr.col.push(c0[0],c0[1],c0[2],c1[0],c1[1],c1[2],c2[0],c2[1],c2[2],c3[0],c3[1],c3[2]);}if(isSolid){const faceUv=FACE_UV_BY_MATERIAL[materialId];arr.mat.push(materialId,materialId,materialId,materialId);arr.uv.push(faceUv[0][0],faceUv[0][1],faceUv[1][0],faceUv[1][1],faceUv[2][0],faceUv[2][1],faceUv[3][0],faceUv[3][1]);}else if(arr.shore)arr.shore.push(packedShore,packedShore,packedShore,packedShore);}
