...
('bird', 1, '{"kind":"bird","motion":{"speed":1.0,"bob":0.018,"sway":0.012,"wingAmplitude":0.065,"wingFrequency":1.8,"tailAmplitude":0.035,"tailFrequency":1.15},"material":{"shimmer":0.16,"glow":0.08,"sparkle":0.12},"zones":{"leftWing":[0.0,0.0,0.48,0.62],"rightWing":[0.52,0.0,1.0,0.62],"body":[0.34,0.2,0.66,0.72],"tail":[0.18,0.55,0.82,1.0]}}'::jsonb),
('fire', 1, '{"kind":"fire","motion":{"speed":1.35,"bob":0.01,"sway":0.045,"wingAmplitude":0.0,"wingFrequency":0.0,"tailAmplitude":0.075,"tailFrequency":2.6},"material":{"shimmer":0.34,"glow":0.22,"sparkle":0.18}}'::jsonb),
...
('tree', 1, '{"kind":"tree","motion":{"speed":0.42,"bob":0.0,"sway":0.026,"branchAmplitude":0.035,"branchFrequency":0.62},"material":{"shimmer":0.03,"glow":0.0,"sparkle":0.01}}'::jsonb),
('grass', 1, '{"kind":"grass","motion":{"speed":0.65,"bob":0.0,"sway":0.052,"branchAmplitude":0.07,"branchFrequency":0.9},"material":{"shimmer":0.02,"glow":0.0,"sparkle":0.0}}'::jsonb),
('flag', 1, '{"kind":"flag","motion":{"speed":0.88,"bob":0.0,"sway":0.018,"waveAmplitude":0.075,"waveFrequency":1.65},"material":{"shimmer":0.04,"glow":0.0,"sparkle":0.0}}'::jsonb),
...
('machine', 1, '{"kind":"machine","motion":{"speed":1.0,"bob":0.002,"sway":0.003,"vibration":0.006,"vibrationFrequency":4.2},"material":{"shimmer":0.08,"glow":0.055,"sparkle":0.025}}'::jsonb),
('glass', 1, '{"kind":"glass","motion":{"speed":0.45,"bob":0.0,"sway":0.0},"material":{"shimmer":0.3,"glow":0.09,"sparkle":0.2}}'::jsonb)
