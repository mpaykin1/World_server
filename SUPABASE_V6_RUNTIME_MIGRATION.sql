...
-- V6: privacy-preserving real-device visual oracle, trace optimizer, chaos evidence, renderer tuning evidence.
alter table public.quality_telemetry
...
-- The existing quality_visual_oracle_results table is reused; keep it service-only.
